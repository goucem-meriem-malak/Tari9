...
public class tow {
    ...
    public tow(String id, String firstname, String lastname, String phone, String dunit, Map<String, Object> address, GeoPoint location, float distance, veh vehicle) {
        this.id = id;
